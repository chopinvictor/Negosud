    ...
    public static class SeedService
    {
        public static void SeedDatabase()
        {
            using (var context = new NegosudContext())
            {
                ...
                context.Clients.Add(new Client() { Id = 1, NomClient = "Zidane", PrenomClient = "Zindine", AdresseClient = "10 rue du cesi, Pau", CodePostalClient = "64000", PaysClient = "France", EmailClient = "ZineZidane@gmail.com", TelephoneClient = "0559532533" });
                context.Clients.Add(new Client() { Id = 2, NomClient = "Martin", PrenomClient = "Cammille", AdresseClient = "123 Rue de la Liberté, Paris", CodePostalClient = "75001", PaysClient = "France", EmailClient = "camille.martin@email.com", TelephoneClient = "0159202253" });
                context.Clients.Add(new Client() { Id = 3, NomClient = "Dubois", PrenomClient = "Julien", AdresseClient = "456 Avenue des Roses, Lyon", CodePostalClient = "69002", PaysClient = "France", EmailClient = "julien.dubois@email.com", TelephoneClient = "0920462577" });
                context.Clients.Add(new Client() { Id = 4, NomClient = "Leroy", PrenomClient = "Elise", AdresseClient = "789 Boulevard du Soleil, Marseille", CodePostalClient = "13006", PaysClient = "France", EmailClient = "elise.leroy@email.com", TelephoneClient = "0433669901" });
                context.Clients.Add(new Client() { Id = 5, NomClient = "Dupont", PrenomClient = "Pierre", AdresseClient = "1010 Rue de l'Avenir, Bordeaux", CodePostalClient = "33000", PaysClient = "France", EmailClient = "pierre.dupont@email.com", TelephoneClient = "0559173065" });
                context.Clients.Add(new Client() { Id = 6, NomClient = "Moreau", PrenomClient = "Emma", AdresseClient = "2020 Avenue des Étoiles, Lille", CodePostalClient = "59000", PaysClient = "France", EmailClient = "emma.moreau@email.com", TelephoneClient = "0130205579" });
                context.Clients.Add(new Client() { Id = 7, NomClient = "Lambert", PrenomClient = "Nicolas", AdresseClient = "303 Rue de la Paix, Paris", CodePostalClient = "75008", PaysClient = "France", EmailClient = "nicolas.lambert@email.com", TelephoneClient = "0430884017" });
                context.Clients.Add(new Client() { Id = 8, NomClient = "Bernard", PrenomClient = "Anna", AdresseClient = "404 Boulevard des Champs, Lyon", CodePostalClient = "69003", PaysClient = "France", EmailClient = "laura.bernard@email.com", TelephoneClient = "0930602522" });
                context.Clients.Add(new Client() { Id = 9, NomClient = "Rodriguez", PrenomClient = "Alejandro", AdresseClient = "10 rue de Porto, Lisbone", CodePostalClient = "1100", PaysClient = "Portugal", EmailClient = "rodriguez@gmail.com", TelephoneClient = "0030330548" });
                context.Clients.Add(new Client() { Id = 10, NomClient = "Zhang", PrenomClient = "Wei", AdresseClient = "Zhonghuang Building #1007, Shanghai", CodePostalClient = "200030", PaysClient = "Chine", EmailClient = "zhangwei@gmail.com", TelephoneClient = "860623034" });
